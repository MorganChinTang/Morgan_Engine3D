...
void GameState::Initialize()
{
    ...
    mCharacter4.Initialize("Character05/Character05.model");

    mCharacter4.animator = &mAnimator4;
    mCharacter5.animator = &mAnimator5;

    mm->AddAnimation(mCharacter4.modelId, L"../../Assets/Animations/Character04/Talking04.animset");
...
void GameState::Update(float deltaTime)
{
    ...
    mAnimator4.Update(deltaTime * mAnimationSpeed);
    mAnimator5.Update(deltaTime * mAnimationSpeed);
}
...
void GameState::Render()
{
    if (mDrawSkeleton)
    {
        ...
        AnimationUtil::ComputeBoneTransforms(mCharacter4.modelId, boneTransforms, &mAnimator4);
...
void GameState::DebugUI()
{
    ...
    if (ImGui::DragInt("AnimIndex", &mClipIndex, 1, -1, maxAnimations4 - 1))
    {
        mAnimator4.PlayAnimation(mClipIndex, true);
    }
    int maxAnimations5 = mAnimator5.GetAnimationCount();
    if (ImGui::DragInt("AnimIndex", &mClipIndex, 1, -1, maxAnimations5 - 1))
    {
        mAnimator5.PlayAnimation(mClipIndex, true);
    }
